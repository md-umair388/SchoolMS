...
<html lang="en">
  ...
  <body>    
   ...
   <!-- Start events-list Area -->
			<section class="gallery-area section-gap" id="contact">
				<div class="container">
					<div class="row">
									...
									{	
									 ...
									 <div class="single-carusel row align-items-center">
									    <div class="col-6 col-md-6 thumb">
									        <?php echo "<a href='img/event/".$row['photo']."' target=_blank><img class='img-fluid' src='img/event/".$row['photo']."' width='250' height='250'>)</a>";?>
									    </div>
