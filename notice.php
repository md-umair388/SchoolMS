...
<!-- start banner Area -->
   ...
   <!-- Start events-list Area -->
			<section id="contact" class="gallery-area section-gap">
				<div class="container">
					<div class="row">
									...
									{	
									 ...
									 <div class="single-carusel row align-items-center">
									    <div class="col-12 col-md-12 thumb">
									        <?php echo "<a href='img/notice/".$row['photo']."' target=_blank><img class='img-fluid' src='img/notice/".$row['photo']."' width='250' height='250'></a>";?>
									    </div>
